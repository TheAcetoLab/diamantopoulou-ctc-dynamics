...
Heatmap showing the Pearson’s correlation coefficient of PC1-`r elbow_point` eigenvectors from gene expression with technical and biological variables in BR16-CDX CTCs. P values by two-sided Pearson’s correlation test (\*P < 0.01, \*\*P <0.001, \*\*\*P <0.0001).
