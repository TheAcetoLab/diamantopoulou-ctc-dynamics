...
To reproduce our analysis, first clone source code from the [GitHub repository](https://github.com/TheAcetoLab/diamantopoulou-ctc-dynamics)
...
Some files containing results from differential expression or gene-set enrichment analyses were deposited in [Zenodo](https://doi.org/10.5281/zenodo.6358987). In order to generate those files again change the option `eval = FALSE` to `eval = TRUE` in the specific code chunk from the R Markdown file.
